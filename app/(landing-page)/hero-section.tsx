...
const HeroSection = () => {
    ...
    return (
        <div className="md:items-center flex flex-col">
            ...
            <div className="font-medium 2xl:w-1/3 md:w-2/3 xl:w-1/2 
                lg:px-0 px-8 text-5xl xl:text-6xl flex justify-center 
                xl:font-medium xl:pt-14 text-center pt-6">
                Your Digital Identity, Reinvented{" "}
            </div>

            <p className=" text-2xl pt-4 text-center w-2/3 mx-auto " >
                Create Once, Identify Everywhere with{" "}
                <span className="text-sky-500 font-bold">IdentiVerse</span>
            </p>
