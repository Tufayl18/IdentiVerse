...
const items = [
    ...
    },
    {
        ...
        button: (
            <div className="text-sky-500 flex items-center  hover:cursor-pointer pt-6">
                Share your verified digital identity securely with others and on all social media
                accounts.
            </div>
        ),
    },
...
const Section = () => {
    return (
        <>
            ...
            <div className="grid xl:grid-cols-4 pb-2 md:grid-cols-2 md:row-span-1 gap-4 xl:gap-6 mt-8 px-8">
